...
def blink_df() -> pd.DataFrame:
    ...
    # Rename legacy columns to snake_case if necessary
...
def test_blink_properties_structure(
    candidate_signal: np.ndarray, blink_df: pd.DataFrame, blink_params: dict
):
    """
